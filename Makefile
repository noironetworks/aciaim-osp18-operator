...
.PHONY: test-kuttl  # Run KUTTL e2e tests against a running cluster
test-kuttl:
	kubectl-kuttl test --config test/kuttl/kuttl-test.yaml
...
catalog-build: opm ## Build a catalog image.
	$(OPM) index add --container-tool $(CONTAINER_TOOL) --mode semver --tag $(CATALOG_IMG) --bundles $(BUNDLE_IMGS) $(FROM_INDEX_OPT) --use-http
