...
rabbit_ssl_ca_file = /etc/aim/certs/ca.crt
rabbit_ssl_ca_certs = /etc/aim/certs/ca.crt
...
/*
    ...
    envVars["REQUESTS_CA_BUNDLE"] = env.SetValue("/etc/aim/certs/ca.crt")
    envVars["SSL_CERT_FILE"] = env.SetValue("/etc/aim/certs/ca.crt")
