module github.com/noironetworks/aciaim-osp18-operator
...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/common v0.6.1-0.20250423055245-3cb2ae8df6f0 // indirect
